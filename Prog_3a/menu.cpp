...
namespace menu {
	...
	int menu_t(int d, Laba3::alphabet& E, Laba3::code_str& S) {
		...
		case 1: {
			...
			std::cout << std::endl << "String for coding:  " ;
			for (int i = 0; i < S.get_str_num(); ++i)
				std::cout << b[i];
			
			std::cout << std::endl << "Number for coding:  "  << S.get_CN() << std::endl << std::endl;
		...
		case 4: {
			...
			try {
				...
				int a = 0;
				std::cout << "Enter number for coding:" << std::endl;
				get_int(a);
				S.set_CN(a);
				E.coding(S );
